...
public sealed class CategorizationService : ICategorizationService
{
    ...
    private Dictionary<string, (string, int)> InitializeKeywordRules()
    {
        return new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "youtube", ("Assinatura", 10) },
            { "netflix", ("Assinatura", 10) },
            { "spotify", ("Assinatura", 10) },
            { "prime", ("Assinatura", 10) },
            { "amazon prime", ("Assinatura", 10) },
            { "disney+", ("Assinatura", 10) },
            { "hbo", ("Assinatura", 10) },
            { "globoplay", ("Assinatura", 10) },
            { "paramount", ("Assinatura", 10) },
            { "apple tv", ("Assinatura", 10) },
            { "crunchyroll", ("Assinatura", 10) },
            { "premium", ("Assinatura", 7) },
            { "subscription", ("Assinatura", 8) },
            { "plano", ("Assinatura", 6) },
