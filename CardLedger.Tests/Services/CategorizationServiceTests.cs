...
public sealed class CategorizationServiceTests
{
    ...
    [InlineData("Zonaazulbarueri", "Carro")]
    [InlineData("Amazonprimebr", "Assinaturas & Contas")]
    [InlineData("Locaweb", "Assinaturas & Contas")]
    ...
    [InlineData("Shein *Shein.Com", "Mayara")]
    [InlineData("Anthropic* Claude Sub", "Assinaturas & Contas")]
    [InlineData("IOF de Anthropic* Claude Sub", "Assinaturas & Contas")]
    [InlineData("IOF de volta de Anthropic* Claude Sub", "Assinaturas & Contas")]
    [InlineData("Shein *Outraloja", "Compras Online")]
